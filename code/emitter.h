    ...
    struct EmitterQueryRecord 
{
    ...
    EmitterQueryRecord(const Vector3f& intersectionNormal, const Vector3f& wi, const Point3f startingPoint)
        : emitter(nullptr), intersectionNormal(intersectionNormal), wi(wi), startingPoint(startingPoint) { }
